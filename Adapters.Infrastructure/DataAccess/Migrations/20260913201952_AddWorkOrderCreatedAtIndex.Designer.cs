...
namespace GarageFlow.Adapters.Infrastructure.DataAccess.Migrations
{
    ...
    [Migration("20260913201952_AddWorkOrderCreatedAtIndex")]
    partial class AddWorkOrderCreatedAtIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GarageFlow.Adapters.Infrastructure.Integrations.Outbox.IntegrationOutboxMessageEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GarageFlow.Adapters.Infrastructure.WorkOrders.Idempotency.IntakeRequestReceipt", b =>
                {
                    ...
                    b.ToTable("WorkOrderIntakeRequests", (string)null);
                });

            modelBuilder.Entity("GarageFlow.Adapters.Infrastructure.WorkOrders.Inbox.EstimateDecisionInboxEvent", b =>
                {
                    ...
                    b.ToTable("EstimateDecisionInboxEvents", (string)null);
                });
            ...
            modelBuilder.Entity("GarageFlow.Domain.WorkOrders.Entities.EstimateServiceLine", b =>
                {
                    ...
                    b.HasIndex("ServiceId", "CompletedAt");
