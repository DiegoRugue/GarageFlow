using GarageFlow.Application.Vehicles.UseCases.VehicleModels.CreateVehicleModel;
...
public class VehicleModelHandlersTests
{
    ...
    public async Task Handle_ShouldCreateVehicleModel_WhenDataIsValid()
    {
        ...
        var handler = new CreateVehicleModelHandler(vehicleModelRepositoryMock.Object, vehicleBrandRepositoryMock.Object);
    ...
    [Fact]
    public async Task Handle_ShouldThrowNotFoundException_WhenVehicleModelDoesNotExist()
    {
        var vehicleModelRepositoryMock = CreateVehicleModelRepositoryMock();
        var handler = new GetVehicleModelByIdHandler(vehicleModelRepositoryMock.Object);

        await Assert.ThrowsAsync<NotFoundException>(
            async () => await handler.Handle(new GetVehicleModelByIdQuery(Guid.NewGuid()), CancellationToken.None));
    }
    ...
    public async Task Handle_ShouldThrowBusinessRuleViolationException_WhenMovingModelToBrandWithSameNormalizedName()
    {
        ...
        var vehicleRepositoryMock = CreateVehicleRepositoryMock();
        var unitOfWorkMock = CreateUnitOfWorkMock();
        var handler = new UpdateVehicleModelHandler(vehicleModelRepositoryMock.Object, vehicleBrandRepositoryMock.Object, vehicleRepositoryMock.Object);
    ...
    public async Task Handle_ShouldDeleteVehicleModel_WhenIdExists()
    {
        ...
        var vehicleRepositoryMock = CreateVehicleRepositoryMock();
        var unitOfWorkMock = CreateUnitOfWorkMock();
        var handler = new DeleteVehicleModelHandler(vehicleModelRepositoryMock.Object, vehicleRepositoryMock.Object);
